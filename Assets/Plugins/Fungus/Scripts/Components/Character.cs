...
namespace Fungus
{
    ...
    {
        [Tooltip("Character name as displayed in Say Dialog.")] [SerializeField]
        protected string
            nameText; // We need a separate name as the object name is used for character variations (e.g. "Smurf Happy", "Smurf Sad")

        [Tooltip("Color to display the character name in Say Dialog.")] [SerializeField]
        protected Color nameColor = Color.white;

        [Tooltip("Sound effect to play when this character is speaking.")] [SerializeField]
        protected AudioClip soundEffect;

        [Tooltip("List of portrait images that can be displayed for this character.")] [SerializeField]
        protected List<Sprite> portraits;

        [Tooltip("Direction that portrait sprites face.")] [SerializeField]
        ...
        [FormerlySerializedAs("notes")] [TextArea(5, 10)] [SerializeField]
        protected string description;

        [Tooltip("Optional, AudioSource to be used for effects and 'beeps' for this Character.")] [SerializeField]
        protected AudioSource effectAudioSource;

        [Tooltip("Optional, AudioSource to be used for voice over AudioClips for this Character.")] [SerializeField]
        ...
        public virtual AudioSource VoiceAudioSource
        {
            ...
            set { voiceAudioSource = value; }
        }

        public virtual AudioSource EffectAudioSource
        {
            get { return effectAudioSource; }
            set { effectAudioSource = value; }
        }

        public virtual GameObject SayDialogGameObject
        {
            get { return setSayDialog.gameObject; }
            set
            {
